...
#    Updated: 2018/11/23 17:55:01 by ynaamane         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_atoi.c ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isacii.c ft_isprint.c \
ft_toupper.c ft_tolower.c ft_memalloc.c ft_memdel.c ft_strnew.c ft_strdel.c \
ft_strclr.c ft_striter.c ft_strmap.c ft_strmapi.c ft_strequ.c ft_strsub.c \
